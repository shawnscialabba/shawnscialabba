...
*   Directed NQA-1 fabrication portfolio exceeding **$50M+ annually**. Reduced design review time by **60%** (saving **$75K/quarter**). (ASME NQA-1, ISO 9001/19443)

**Emergency Operations & Safety**
*   Held ultimate control authority over ESF systems; led **50+** drills with a flawless response record. Achieved facility **record-low shutdown dose**. (NRC-aligned requirements, ALARA principles)

**Compliance & Oversight**
*   Managed 100+ engineering changes with **zero non-conformances**. Averted estimated **$500k+** in potential regulatory fines. (10 CFR 50, App B, DCD/ECN Governance)

**Export Control**
*   Acted as SME for **10 CFR Part 810** ("Deemed Exports"), preventing potential federal penalties up to **$300k/violation**. (10 CFR 810)

**Vendor QA & Engineering**
*   Directed vendor verification for safety-critical components; achieved **15% material cost reduction** in seismic design. (ASME BPVC Sec III, Div 1, Class 1, ASCE 4/43 Seismic Standards)
...
*   **Clearance:** Secret Security Clearance (DoD, Active)
*   **Medical:** Combat Medic (68W) & EMT-B Certification
